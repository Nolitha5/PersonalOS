...
|---|---------|---------------|------|---------|------------|
| 1 | /sprint-tracker | work/01-sprint-tracker/ | scheduled | Reads Notion progress board, generates standup summary, tracks velocity | feeds velocity-history |
| 2 | /morning-brief | work/02-morning-brief/ | scheduled | Gmail + Calendar + Notion → filtered daily brief, saved locally and to Notion | feeds morning-brief/history |
| 3 | /market-pulse | work/03-market-pulse/ | scheduled | Competitor scrape + web search → tagged market brief, saved locally and to Notion | feeds morning-brief Key Context |
...
## Working Memory (Productivity Plugin)

### Projects
| Codename | What |
|----------|------|
| **Personal OS** | Claude automation framework in this folder. 10 automations to build via /new, tracked on Notion progress board. |

### Terms
| Term | Meaning |
|------|---------|
| soul.md | Agent identity file — voice, priorities, role. Injected at session start. |
| Weekly Exec Report | Weekly report produced by the user for themselves as a personal review. |
| sprint-tracker | Automation #1. Reads Notion progress board, generates standups, tracks velocity. |
...
| vault/index.md | Vault catalog |
| vault/log.md | Append-only activity log |
| scheduler/schedule.md | Scheduled task registry |
